...
import serviceclients.fakes.FakeVehicleLookupWebService.RegistrationNumberWithSpaceValid
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsNoResponse
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsResponseDocRefNumberNotLatest
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsResponseNotFoundResponseCode
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsResponseSuccess
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsResponseVRMNotFound
import serviceclients.fakes.FakeVehicleLookupWebService.vehicleDetailsServerDown
...
import serviceclients.fakes.brute_force_protection.FakeBruteForcePreventionWebServiceImpl.VrmAttempt2
import serviceclients.fakes.brute_force_protection.FakeBruteForcePreventionWebServiceImpl.responseFirstAttempt
import serviceclients.fakes.brute_force_protection.FakeBruteForcePreventionWebServiceImpl.responseSecondAttempt
import serviceclients.fakes.brute_force_protection.FakeBruteForcePreventionWebServiceImpl.VrmThrows
...
final class VehicleLookupUnitSpec extends UnitSpec {
  ...
  "present" should {
    ...
    "display data captured in previous pages" in new WithApplication {
      ...
      content should include(serviceclients.fakes.FakeAddressLookupService.PostcodeValid)
    }
