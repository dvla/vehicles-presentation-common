...
class SetupTradeDetailsFormSpec extends UnitSpec {
  ...
  "traderBusinessName" should {
    "reject if trader business name is blank" in new TestWithApplication {
    ...
    "reject if trader business name is less than minimum length" in new TestWithApplication {
    ...
    "reject if trader business name is more than the maximum length" in new TestWithApplication {
    ...
    "accept if trader business name is valid" in new TestWithApplication {
  ...
  "postcode" should {
    "reject if trader postcode is empty" in new TestWithApplication {
      // IMPORTANT: The messages.en being returned by the form validation are overridden by the Controller
    ...
    "reject if trader postcode is less than the minimum length" in new TestWithApplication {
    ...
    "reject if trader postcode is more than the maximum length" in new TestWithApplication {
    ...
    "reject if trader postcode contains special characters" in new TestWithApplication {
    ...
    "reject if trader postcode contains an incorrect format" in new TestWithApplication {
