...
class ServiceClosingWarningSpec extends UnitSpec {
  "Show x minutes before closing" in {
    val result = ServiceClosingWarning.warning(60,51, minutesAfter0(10)) // 01:00
    result should be (Some("00:50.00"))

  }

  "Not show after closing time" in {
    val result = ServiceClosingWarning.warning(60,59, minutesAfter0(61))
    result should be (None)
  }

  "Not show earlier then x minutes before closing" in {
    val result = ServiceClosingWarning.warning(160,49, minutesAfter0(10))
    result should be (None)
  }

  "Show warning for the 24 hours case" in {
    val result = ServiceClosingWarning.warning(1440,50, minutesAfter0((23 hours).toMinutes + 11))
    result should be (Some("00:49.00"))
  }

  "Not show warning for the 24 hours case" in {
    val result = ServiceClosingWarning.warning(1440,50, minutesAfter0((23 hours).toMinutes + 9))
    result should be (None)
  }
