#!/bin/bash
###
### Script to capture the steps required when open sourcing the common component for the micro service layer
### eg. vehicles-seevices-common
...
COMPONENT_NAME="vehicles-services-common"
...
echo "This script will open source vehicles-services-common for the micro service layer"
